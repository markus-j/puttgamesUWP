    ...
    public sealed partial class MXXVGamePage : Page
    {
        ...
        private void getAndSaveResults()
        {
            ...
            for (int i = 0; i < pivot.Items.Count; ++i)
            {
                ...
                MXXVPivotItem pivotItem = item.Content as MXXVPivotItem;
                ...
                newResult.Add("ResultGameModeId", JsonValue.CreateStringValue("0"));
        ...
        private void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            for (int i = 0; i < selectedPlayers.Count; ++i)
            {
                ...
                MXXVPivotItem cxItem = new MXXVPivotItem();
        ...
        private void NavigationHelper_SaveState(object sender, SaveStateEventArgs e)
        {
            ...
            for (int i = 0; i < pivot.Items.Count; ++i)
            {
                ...
                //Debug.WriteLine("pagestate.add: " + i.ToString() + pivotItem.getState());
            }
